...
TOKEN = "7924054088:AAH0DpoP5QrAz_14enDYNzVEFHQ9yTs2zCc"  # ← Это твой токен от BotFather
...
async def button(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    responses = {
        'lesson1': "🎧 Урок 1: [аудио, видео, текст, фото]",
        'lesson2': "🎥 Урок 2: [здесь будет контент]",
        'lesson3': "📖 Урок 3: [здесь будет контент]",
        'lesson4': "📝 Урок 4: [здесь будет контент]",
        'lesson5': "🎤 Урок 5: [здесь будет контент]",
        'books': "📚 Книги и пособия: [ссылки или файлы]"
    }
